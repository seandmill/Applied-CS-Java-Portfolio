...
public class PasswordHistory<E> implements Iterable<E> {
    // ---------------- nested Node class ----------------
    ...
    /**
     * Creates a contains method for our DoublyLinkedList. Walks through each node, searching for
     * object o.
     * 
     * @param o
